...
def cleanup_project():
    ...
    # Directories to clean (add project-specific folders if needed)
    cache_dirs = [
        "__pycache__",
        ".pytest_cache",
        ".mypy_cache",
    ...
    # Clean empty directories (keep structure for these)
    empty_dirs = ["cache", "exports", "logs", "Data", "Features", "Tests"]
